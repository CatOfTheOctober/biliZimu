...
B站视频文字提取系统 - 一个智能的文本提取工具，能够从B站视频中提取文字内容。

## 📋 项目简介

本项目采用混合方案，优先使用官方字幕以获得最佳准确度和速度，在无官方字幕时自动降级到ASR语音识别。系统支持中文优化的FunASR引擎和多语言的Whisper引擎。

### 核心特性

- ✅ **智能两阶段处理**：优先使用B站API获取字幕（含AI字幕），无字幕时自动使用ASR
